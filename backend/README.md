...
## Project Structure
    ...
    ├── testapiautoconnect_119715  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_119715`
...
2. Clone this repo and `cd testapiautoconnect_119715`
